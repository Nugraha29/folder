            ...
            <div class="card ">
              <div class="card-header card-header-warning">
                ...
                <div class="view view-cascade gradient-card-header blue-gradient narrower d-flex justify-content-between align-items-center">
                  ...
                  <h4 class="card-title">Form Pengajuan Pelaporan Limbah B3</h4>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-9">
                    <div class="form-group{{ $errors->has('jenis') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('jenis') ? ' is-invalid' : '' }}" name="jenis" id="input-jenis" type="text" value="LimbahB3" required="false" aria-required="false" readonly/>
                      @if ($errors->has('jenis'))
